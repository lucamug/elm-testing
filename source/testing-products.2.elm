...
view model =
    div
        ...
        [ header
        , div [] [ changeMsgType Product1 (Products.view model.product1) ]
        , div [] [ changeMsgType Product2 (Products.view model.product2) ]
        , div [] [ changeMsgType Product3 (Products.view model.product3) ]
        , div [] [ changeMsgType Product4 (Products.view model.product4) ]
        , footer
        ]



-- This function change type of Msg from Product.Msg to Main.Msg
